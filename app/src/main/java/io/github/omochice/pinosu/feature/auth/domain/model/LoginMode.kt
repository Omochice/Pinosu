 ...
 *
 * Determines user capabilities: [Nip55Signer] allows full read/write,
 * [ReadOnly] restricts to browse-only.
 */
@Serializable
sealed interface LoginMode {
  ...
  @Serializable data object Nip55Signer : LoginMode {
    override val isReadOnly: Boolean = false
  }

  /** Read-only login via direct npub public key entry */
  @Serializable data object ReadOnly : LoginMode {
